...
- Textual data: `r pkg("tidytext")` 
- Network data: `r pkg("igraph")` for network computation, as in the chapter. But several **ggplot2**2 extension packages for plotting the networks.
- Spatial data: `r pkg("ggplot2")` has some built-in support for maps. The `r pkg("map")` package provides map data.
...
```{r warning = FALSE, message = FALSE, fig.show = "animate",fig.cap="The Expansion of Walmart"}
walmart_animated <-
  ggplot() +
    borders(database = "state") +
