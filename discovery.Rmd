...
- Network data: `r pkg_link("igraph")` for network computation, as in the chapter. But several **ggplot2**2 extension packages for plotting the networks.
...
The default tokenization removes punctuation, and lower-cases the words.
...
- **ggfortify**: `fortify` and `autoplot` allows **ggplot2** to handle some popular R packages. https://journal.r-project.org/archive/accepted/tang-horikoshi-li.pdf
